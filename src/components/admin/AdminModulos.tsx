  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => setShowNew(true)} className="bg-accent text-accent-foreground hover:bg-accent/80 gap-2">
      ...
      {modulosQuery.isLoading ? (
        ...
        <Card className="p-10 text-center text-muted-foreground">Nenhum módulo cadastrado.</Card>
      ) : (
